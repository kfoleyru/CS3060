    ...
    def Update_Hidden_Or_Motor_Neuron(self, neurons, synapses):
        ...
        for key in synapses.keys():
            if (key[1] == self.Get_Name()):
                self.Allow_Presunaptic_Neuron_To_Influence_Me(synapses[key].Get_Weight(), neurons[key[0]].Get_Value())
        self.Threshold()
    
    def Allow_Presunaptic_Neuron_To_Influence_Me(self, weight, pnval):
        self.Add_To_Value(weight * pnval)
